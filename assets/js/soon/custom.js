...
(function($) {
    ...
    **/
    var launch = new Date(2015, 03, 12, 15, 00);
    /**
    * The script
    **/
    var message = $('#message');
...
function sendAj(){
 ...
 var request = $.ajax({
  ...
  request.done(function(msg){
	  $("#letmeknow").prop('disabled', true).addClass('hidden');
	  $("#thanks").prop('disabled', false).removeClass('hidden');
	  $("#thanks").prop('visibility', 'visible');
  });
